...
the server is in pollserver.cpp file and the client is in pollclient.cpp file
                          ...
                          *-HOW TO RUN-*
First open a terminal in the Design-Patterns directory and type <make all>.
...
e) To run the pollserver type<./pollServer>, after you run the server you can run several client
   and send messages between them to run a client open a new terminal and run <./pollClient 127.0.0.1>

The malloc implementation is from the previous assigment in this course (from assigment 4).